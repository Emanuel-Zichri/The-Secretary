    ...
    container.append(`
        <div class="parquet-item">
          <div style="position:relative">
            <img src="../picturs/parquetsTypes/${item.imageURL}" alt="${
      item.typeName
    }" />
            <div class="info-btn" onclick='showInfo(${JSON.stringify(
              item
            )})'>i</div>

          </div>
          <div style="margin-top: 8px; font-weight: 500; font-size: 14px;">${
            item.typeName
          }</div>
...
function showInfo(item) {
  ...
  document.getElementById("info-image").src =
    item.imageURL || "../picturs/default.jpg";
